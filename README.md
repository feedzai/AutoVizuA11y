...
| `shortcutGuide` <a id="shortcutGuideProp"></a> | Optional            | JSX.Element      | AutoVizuA11y has its default `NativeShortcutGuide` but you may create your own. Since the ShortcutGuide is wrapped in a <dialog>, a closing button should be set accordingly.                                                                                                                                                                                                                                                                                                                                                                                                                                            |
