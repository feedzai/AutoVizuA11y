...
You can check a series of examples built using AutoVizuA11y [here](https://anonymous.4open.science/r/autovizua11y-examples-BB4E/) (it requires an OpenAI API key).
